  ...
  return (
    <div className="bg-white rounded-2xl  shadow p-4">
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="bg-green-500 text-white text-sm font-medium px-4 py-1 rounded-xl">
          Active
        </span>
      </div>
        ...
        <div className="border-r">
          ...
          <div className="p-3 text-sm space-y-3">
            <div>
              ...
              <p className="font-semibold pt-3">Harry Singh</p>
            ...
            <div>
              <p className="font-semibold pt-9">Office Compliance Required</p>
